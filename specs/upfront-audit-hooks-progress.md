...
## Phase 6: Install script + README + sample data — COMPLETE

**What changed:** `install.sh`, `README.md`, `examples/sample-audit.jsonl`
**TDD cycles:** N/A (no logic — config, docs, static assets)
**Review findings:** Sample JSONL had literal newlines in thinking_summary strings — regenerated via Go json.Marshal for proper escaping.
**Surprises:** None
**Learnings:** Sample JSONL should always be generated by the same serializer (Go json.Marshal) to avoid encoding mismatches.
